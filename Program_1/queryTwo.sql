...
INSERT INTO project(cid, name, notes)
  VALUES((SELECT id FROM client WHERE first_name = 'Miguel' AND last_name = 'Cabrera'), 'The Robinson Project', NULL);

INSERT INTO works_on(eid, pid, start_date)
  VALUES((SELECT id FROM employee WHERE first_name = 'Ananya' AND last_name = 'Jaiswal'), (SELECT id FROM project WHERE name = 'Chan\'g'), '2012-01-01');
INSERT INTO works_on(eid, pid, start_date)
  VALUES((SELECT id FROM employee WHERE first_name = 'Michael' AND last_name = 'Fern'), (SELECT id FROM project WHERE name = 'The Robinson Project'), '2013-08-08');
INSERT INTO works_on(eid, pid, start_date)
  VALUES((SELECT id FROM employee WHERE first_name = 'Abdul'  AND last_name = 'Rehman'), (SELECT id FROM project WHERE name = 'Diamond'), '2014-09-11');
